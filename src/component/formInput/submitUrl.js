...
const SubmitUrl =()=>{
    ...
    return(
        <section className="container flex flex-col md:flex-row mx-auto h-auto -top-12 p-8 relative rounded-md md:bg-shorten-desktop bg-DarkViolet">
            ...
            <button onClick={SubmitUrl} className="flex-grow-0 px-8 py-3 mt-6 lg:mt-0 bg-Cyan rounded-lg text-White text-lg font-semibold hover:bg-opacity-50 focus:shadow-outline">Shorten It!</button>
        </section>
    )
}
