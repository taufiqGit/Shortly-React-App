    ...
    return(
        <div className="container mx-auto px-8 lg:px-16 pb-48 mt-6 h-auto w-full flex flex-col-reverse lg:flex-row overflow-x-hidden font-Poppins">
            <section className="lg:w-10/12 text-center lg:text-left">
                <h1 className="text-4xl xl:text-6xl font-bold mt-10 leading-tight text-VeryDarkViolet">More than just shorter links</h1>
                <p className="mt-1 max-w-xl text-GrayishViolet">Build your brand’s recognition and get detailed insights 
